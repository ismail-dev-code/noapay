        ...
        <div className="navbar-end flex items-center gap-4">
          {user ? (
            ...
            <>
              ...
              <Link
                to="/register"
                className="px-5 py-2 hidden rounded-xl bg-gradient-to-r from-teal-500 to-green-600 text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300"
              >
                Register
              </Link>
            </>
