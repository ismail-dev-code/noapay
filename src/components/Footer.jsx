...
const Footer = () => {
  return (
    <>
      <div className="bg-linear-to-l from-success to-[rgba(239,239,239,0)]">
        <div className="footer grid md:grid-cols-3 grid-cols-2 lg:grid-cols-5  text-base-content p-10 pb-3">
          <aside>
          ...
          <nav>
            ...
            <div className="flex flex-row gap-2.5">
              ...
              <Link
                target="_blank"
                to={"https://www.linkedin.com/in/ismail-hossain24/"}
                className="link link-hover"
              >
                <FaLinkedin size={35} />
              </Link>
        ...
        <p className="text-center text-nowrap">
          <small>
            © {new Date().getFullYear()} - All rights reserved by Ismail
            initiative.
          </small>
        </p>
      </div>
