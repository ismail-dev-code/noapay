...
const Login = () => {
    ...
    <div className="card bg-base-100 w-full mt-16 mx-auto max-w-sm shrink-0 shadow-2xl">
      ...
      <h1 className="text-3xl font-bold">Login here!</h1>
        <form>
          ...
          <button type='submit' className="btn btn-neutral bg-primary text-white border-none mt-4">Login</button>
        </form>
  ...
  Login with Google
        ...
        <p>New to this website? Please <Link className='text-error' to={'/register'}>Register</Link></p>
